#!/usr/bin/env sh
# To be hashi-agents-install.sh
# This is consul-download.sh from https://github.com/hashicorp/prod-setup/blob/main/scripts/consul-download.sh
# previously https://github.com/wilsonmar/hashicups/blob/main/consul-download.sh
...
h2 "Verify the SHASUM matches the archive."
...
if [ -f "consul_${CONSUL_VERSION}_${PLATFORM}.zip" ]; then  # found:
   yes | unzip "consul_${CONSUL_VERSION}_${PLATFORM}.zip"
